...
const TopGradientCard = () => {
  return (
    <>
      ...
      >
        <View className="flex-row gap-5 items-center bg-muted/20 border border-muted/40 rounded-2xl  px-8 py-2">
        ...
        <View className="flex-row gap-3">
          <View className="gap-3 flex-row justify-center items-center bg-purple/20 rounded-2xl p-3">
